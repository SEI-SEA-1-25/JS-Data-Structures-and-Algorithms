...
// // A different solution (courtesy of Weston the O.G.)
// function whileBubble(arr) {
//     // two booleans flags to check if it has been sorted and if a swap was made
//     let isSorted = false
//     let didSwap = false
...
//             //  check if we are at the end of the for loop
//             if(i === arr.length - 1) {
//                 if(didSwap) {
//                     // reset didSwap
//                     didSwap = false
//                 } else {
//                     // this only happens when didSwap is false
//                     isSorted = true
//                 }
//             }
//         }
